...
<div class="container  ">
    <div class=" milestone shadow p-0 mx-5 mb-5 pb-2 col-md-11 mx-auto  bg-body rounded-5 text-center text-md-start">
        <div class="d-flex flex-wrap ">
            ...
            <a style="background-color: #262d61 ;border-radius:0px 32px 0px 0px" href="flight-status.html" class="text-light btn p-2 text-center col-12 col-md-4">
        ...
        <div class="d-flex mt-4 mx-4 mb-4 p-0 pb-2 border-bottom">
            <a href="manage-booking-page.html" class="btn text-primary mx-4 fs-6">Manage Booking</a>
            <a href="check-in-page.html" class="btn  fs-6">Check in</a>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-12 d-flex flex-wrap">
                ...
                <div class="col-md-3 col-12 mt-3 mt-md-0 ml-auto">
                    <button style="background-color: #262D61; margin-left:60px" class="p-3 shadow px-4 rounded-5 text-light btn">Retrieve booking</button>
                </div>
            </div>
